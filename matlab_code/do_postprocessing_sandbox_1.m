ObjIdx = 1:19;
% datafolder ='/home/thanhnguyen/UNCC_2012/programs/data_preprocessing/examples/postprocessing';
datafolder ='/home/tnguy152/UNCC_2012/programs/WORK_GCA_sandbox_1';
datafile = 'prop_dat_inv_w_s9.00_7.00_41.m';
final_result_folder = 'final_results_Larisa';
% final_result_folder = 'final_results';
objfilename = 'object'; % common part of object result files to be created
...
parfile_preprocessing = '/home/tnguy152/UNCC_2012/programs/WORK_GCA_sandbox_1/parameters_for_preprocessing.dat';

bckgr_coef = 4; % background dielectric constant
...
truncate_reconstructed_coefficient(bckgr_coef,datafolder,datafile,final_result_folder,objfilename,parfile_preprocessing,...
    parfile_fp,parfile_vis,object_properties_sandbox_1,...
    ObjIdx,Threshold_CrossSection,thickness_threshold_Larisa,targetdepths_sandbox_1);
