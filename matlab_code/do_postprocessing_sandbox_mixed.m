ObjIdx = 2:4;
datafolder ='/home/tnguy152/UNCC_2012/programs/WORK_GCA_sandbox_mixed';
...
parfile_fp = 'parameter_forprob.dat'; % this file should be in the "datafolder".
...
parfile_preprocessing = '/home/tnguy152/UNCC_2012/programs/WORK_GCA_sandbox_mixed/parameters_for_preprocessing.dat';
...
truncate_reconstructed_coefficient(bckgr_coef,datafolder,datafile,final_result_folder,objfilename,parfile_preprocessing,...
    parfile_fp,parfile_vis,object_properties_sandbox_mixed,...
    ObjIdx,Threshold_CrossSection,thickness_threshold_Larisa,targetdepths_sandbox_mixed);
